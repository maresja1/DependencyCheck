...
CREATE TABLE software (cveid INT, cpeEntryId INT, versionEndExcluding VARCHAR(255), versionEndIncluding VARCHAR(255),
                       versionStartExcluding VARCHAR(255), versionStartIncluding VARCHAR(255), vulnerable BOOLEAN
